...
pub mod fixtures {
    ...
    pub fn sample_intent(flags: Flags) -> OrderIntent {
        OrderIntent {
            owner: pubkey_from_seed("sample_intent's owner"),
            sell: TokenAsset {
                token_account: pubkey_from_seed("sample_intent's sell token_account"),
                mint: pubkey_from_seed("sample_intent's sell mint"),
            },
            buy: Asset::TokenProgram(TokenAsset {
                token_account: pubkey_from_seed("sample_intent's buy token_account"),
                mint: pubkey_from_seed("sample_intent's buy token mint"),
            }),
...
mod tests {
    ...
    fn uid_digest_regression() {
        ...
        assert_eq!(
            ...
            "183cef240a1bb6fe55104dd53bf14e86dce063857194c7bfd244dfef1f2e84b5",
        );
    }
    ...
    fn encoding_regression() {
        ...
        let expected: [u8; EncodedOrderIntent::SIZE] = [
            // owner (pubkey_from_seed("sample_intent's owner"))
            0x03, 0xb3, 0x52, 0x93, 0x2b, 0x53, 0xbc, 0x48,
            0x65, 0x80, 0xcd, 0xd3, 0x57, 0x1d, 0x2a, 0x4b,
            0xda, 0x6a, 0xde, 0x4f, 0x20, 0xed, 0xa2, 0x4d,
            0xbd, 0xe5, 0x3c, 0xdb, 0x9e, 0x2e, 0x5e, 0x68,
            // sell_token_account (pubkey_from_seed("sample_intent's sell token_account"))
            0x17, 0x8f, 0x9e, 0x76, 0xfa, 0x06, 0x04, 0x16,
            0x99, 0x2f, 0xdc, 0x7f, 0x99, 0xf8, 0x68, 0x3f,
            0xe0, 0x90, 0x89, 0xf6, 0x03, 0xf7, 0xce, 0xda,
            0x09, 0xfa, 0xf0, 0x06, 0xb7, 0xe4, 0x9a, 0x89,
            // sell_mint (pubkey_from_seed("sample_intent's sell mint"))
            0xaa, 0xe7, 0x58, 0x8b, 0x2b, 0x4d, 0x93, 0x96,
            0x89, 0xba, 0xad, 0x1e, 0xd3, 0x35, 0x7b, 0x90,
            0x42, 0x67, 0x9b, 0xea, 0x65, 0x10, 0xb1, 0xbc,
            0x73, 0x60, 0xcb, 0xf9, 0xf2, 0xb1, 0x9e, 0x19,
            // buy_token_account (pubkey_from_seed("sample_intent's buy token_account"))
            0xc9, 0x91, 0x33, 0x75, 0x14, 0xd0, 0xff, 0xce,
            0xb0, 0x3d, 0xf5, 0x11, 0xa4, 0x4a, 0x24, 0x46,
            0xda, 0x37, 0x2f, 0x79, 0x88, 0x3c, 0x1c, 0xf8,
            0xf9, 0xc6, 0x4c, 0x4e, 0x16, 0xb6, 0x53, 0x94,
            // buy_mint (pubkey_from_seed("sample_intent's buy token mint"))
            0x81, 0x5f, 0x6c, 0x66, 0xee, 0x73, 0x06, 0xcc,
            0x5b, 0x0c, 0x46, 0xe2, 0xb6, 0x0b, 0xaf, 0xcc,
            0xe4, 0xa9, 0x86, 0xbe, 0x3b, 0xb6, 0x3f, 0xa7,
            0x7d, 0x60, 0x0d, 0x79, 0x55, 0x21, 0x98, 0xdc,
