...
/// [`OrderBuilder::sell_mint`] / [`OrderBuilder::buy_mint`]. Pinning the buy
/// mint to the native SOL marker is the exception: proceeds are then lamports,
/// so the buy side gets a plain address rather than a token account.
