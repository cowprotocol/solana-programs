...
pub const CREATE_SWEEP_ORDER_RS: Source = Source {
    display: "interface/src/instruction/create_sweep_order.rs",
    text: include_str!("../../../../interface/src/instruction/create_sweep_order.rs"),
};
