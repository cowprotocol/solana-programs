...
const INSTRUCTIONS: &[Instruction] = &[
    ...
    Instruction {
        variant: SettlementInstruction::CreateSweepOrder,
        input: &parse_rust::CREATE_SWEEP_ORDER_RS,
...
fn field_override(owner: &str, field: &str) -> Option<(String, Value)> {
    match (owner, field) {
        ...
        // they decode to.
        ("CreateOrderInput", "intent_bytes") | ("CreateSweepOrderInput", "intent_bytes") => Some((
            "intent".to_string(),
